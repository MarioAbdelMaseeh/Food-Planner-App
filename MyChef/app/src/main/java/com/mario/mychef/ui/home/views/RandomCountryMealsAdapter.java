...
public class RandomCountryMealsAdapter extends RecyclerView.Adapter<RandomCountryMealsAdapter.ViewHolder>{
    List<MealsResponse.MealDTO> meals;
    private HomeRecyclerAdapterHelper homeRecyclerAdapterHelper;

    public RandomCountryMealsAdapter(List<MealsResponse.MealDTO> meals, HomeRecyclerAdapterHelper homeRecyclerAdapterHelper) {
        this.meals = meals;
    ...
    @NonNull
    @Override
    public RandomCountryMealsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View v = inflater.inflate(R.layout.meal_card, parent, false);
        return new RandomCountryMealsAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull RandomCountryMealsAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
